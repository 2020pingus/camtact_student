...
export default function ProgressExamSuperviseCard(props) {
    ...
    <div className={classes.content} ms={6} >
        ...
        <Card className={classes.card}>
          ...
          <div className={classes.footer}>
            <Button className={classes.button} style={{width: '100%', marginLeft: -25, color: '#FF5E57'}} onClick={handleClickOpen}>시험 감독</Button>
          </div>
        </Card>
      </Box>
    </div>
